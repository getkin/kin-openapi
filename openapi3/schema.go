...
func (schema *Schema) UnmarshalJSON(data []byte) error {
	...
	*schema = Schema(x)
	...
	if schema.Format == "date" {
		// This is a fix for: https://github.com/TykTechnologies/kin-openapi/issues/697
...
func (schema *Schema) visitJSON(settings *schemaValidationSettings, value any) (err error) {
	...
	case map[any]any: // for YAML cf. issue https://github.com/TykTechnologies/kin-openapi/issues/444
