...
// When JSON Schema 2020-12 keywords are used, unresolved schema references are
// returned to the caller instead of being silently ignored by falling back to
