  ...
  examples:
   ...
   `,
      ...
      example:
        ...
        # missing password
   `,
			errContains: "CreateUserRequest: invalid schema example",
		},
		{
   ...
   `,
			errContains: "CreateUserResponse: invalid schema example",
		},
		{
...
`,
			errContains: "invalid components: example BadUser: example has no value or externalValue field",
		},
		{
